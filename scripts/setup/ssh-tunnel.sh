#!/bin/bash
#
# Create a persistent SSH tunnel for Claude Nook
...
if [[ -z "$REMOTE_HOST" ]]; then
    ...
    echo ""
    echo "Creates a persistent SSH tunnel for Claude Nook TCP connections."
    echo ""
    echo "Arguments:"
