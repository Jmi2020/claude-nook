...
private let logger = Logger(subsystem: "com.jmi2020.claudenook", category: "Interrupt")
...
class JSONLInterruptWatcher {
    ...
    private let queue = DispatchQueue(label: "com.jmi2020.claudenook.interruptwatcher", qos: .userInteractive)
