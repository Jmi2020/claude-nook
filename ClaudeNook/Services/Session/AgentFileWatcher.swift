...
private let logger = Logger(subsystem: "com.jmi2020.claudenook", category: "AgentFileWatcher")
...
class AgentFileWatcher {
    ...
    private let queue = DispatchQueue(label: "com.jmi2020.claudenook.agentfilewatcher", qos: .userInitiated)
