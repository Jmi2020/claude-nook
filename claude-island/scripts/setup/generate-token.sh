#!/bin/bash
#
# Generate a secure auth token for Claude Island TCP connections
...
echo "=== Claude Island Auth Token ==="
echo ""
echo "Generated token:"
echo "  $TOKEN"
echo ""
echo "Add to your environment (on the REMOTE machine):"
echo "  export CLAUDE_ISLAND_TOKEN=\"$TOKEN\""
echo ""
echo "Or add to ~/.config/claude-island/claude-island.env:"
echo "  CLAUDE_ISLAND_TOKEN=$TOKEN"
echo ""

# Optionally save to file
if [[ "$1" == "--save" ]]; then
    TOKEN_FILE="${2:-$HOME/.config/claude-island/token}"
