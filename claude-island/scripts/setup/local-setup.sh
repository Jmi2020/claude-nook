#!/bin/bash
#
# Setup Claude Island on the LOCAL macOS machine (where the app runs)
...
echo "=== Claude Island Local Setup ==="
echo ""
echo "This script configures your Mac to accept remote Claude Island connections."
echo ""
...
cat > "$INFO_FILE" << EOF
# Claude Island Remote Setup Information
...
# Connection Settings
CLAUDE_ISLAND_HOST=<your-ip-or-tailscale-hostname>
...
echo "=== Next Steps ==="
echo ""
echo "1. Enable TCP in Claude Island app:"
echo "   - Open Claude Island settings (click the notch)"
